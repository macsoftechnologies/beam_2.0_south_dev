...
export function generatePermitHtml(data: any): string {
  ...
  const attachmentsHtml = data.files && data.files.length > 0
    ? `<div class="attachments-grid" style="margin-top: 6px;">
      ...
      return `
            <a href="/development/m3south/requests/files/${fileId}" target="_blank" download class="attachment-box">
...
<body>
  ...
  <script>
    function test() {
      window.location.href = "/development/m3south/requests/permit-design/${data.PermitNo}/pdf";
    }
  </script>
</body>
</html>
